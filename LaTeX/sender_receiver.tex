...
The objective of this section is to show how the system was implemented, discuss some of the choices that were made and present the block diagrams of sender and receiver. Our aim is to implement and tune a system that can be used with different communication systems (i.e. localhost, WLAN, internet) and assess the performances of network coding schemes in these networks.
